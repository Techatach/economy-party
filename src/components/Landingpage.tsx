...
export default function Landingpage() {
  return (
    <div>
              ...
              <div className="col-lg-6">
                <div className="carousel-text">
                  <h1 className="display-5 text-uppercase mb-3">
                    การคอร์รัปชัน = ประหาร
                  </h1>
                  <p className="fs-5 mb-5">
                    เศรษฐกิจจะเดินหน้าต้องแก้ปัญหาคอร์รัปชัน
                    มาร่วมมือกันเปลี่ยนแปลงประเทศไทยไร้คอร์รัปชัน
                  </p>
                  <div className="d-flex">
                    <a className="btn btn-warning py-3 px-4 me-3" href="#!">
            ...
            <div className="row g-5 align-items-center">
              <div className="col-lg-6">
                <div className="carousel-text">
                  ...
                  <p className="fs-5 mb-5">
                    เศรษฐกิจจะเดินหน้าต้องแก้ปัญหาคอร์รัปชัน
                    มาร่วมกันเปลี่ยนแปลงประเทศไทยไร้คอร์รัปชัน
                  </p>
      ...
      {/* Video Start */}
      <div
        className="container-fluid bg-warning mb-5 wow fadeIn"
        data-wow-delay="0.1s"
      >
          ...
          <div className="row g-5 align-items-center">
            ...
            <div className="col-lg-6">
              ...
              <h1 className="display-6 mb-4 wow fadeIn" data-wow-delay="0.2s">
                ร่วมมือกันเปลี่ยนแปลงประเทศไทยไร้คอร์รัปชัน
              </h1>
          ...
          <div className="row g-5">
            ...
            >
              <div className="service-title">
                <h2 className="mb-4">
                  อะไรที่ทำให้พรรคเศรษฐกิจต้องแก้ปัญหาคอร์รัปชันก่อน
                </h2>
                <p className="fs-5 mb-0">
                  ตราบใดที่ยังมีคอร์รัปชัน ประเทศไทยจะไม่สามารถพัฒนาได้
                  และการจัดสรรทรัพยากรของชาติก็ไม่วันตกถึงมือคนจนได้
                </p>
              </div>
            </div>
      ...
      <div className="container-fluid py-5">
        <div className="container">
          <div className="row g-5 align-items-center">
            ...
            <div className="col-lg-6">
              <p className="section-title bg-white text-start text-primary pe-3">
                ทำไมต้องเลือกพรรคเศรษฐกิจ
              </p>
              <h1 className="display-6 mb-4 wow fadeIn" data-wow-delay="0.2s">
                เหตุผลว่าทำไมต้องเลือกพรรคเศรษฐกิจ
              </h1>
              <p className="mb-4 wow fadeIn" data-wow-delay="0.3s">
        ...
        <div className="container">
          ...
          >
            ...
            <h1 className="display-6 mb-4">
              มาเป็นส่วนหนึ่งของการหยุดคอร์รัปชัน
            </h1>
          </div>
          <div className="row g-4">
      ...
      <div className="container-fluid py-5">
        <div className="container">
          ...
          >
            ...
            <h1 className="display-6 mb-4">พบกับทีมงานของเรา</h1>
          </div>
          <div className="row g-4">
            <div className="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.1s">
