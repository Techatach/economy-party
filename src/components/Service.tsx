      ...
      <>
        ...
        >
          <div className="container text-center py-4">
            <h1 className="display-6 animated slideInDown">บริการ</h1>
            <nav aria-label="breadcrumb animated slideInDown">
              <ol className="breadcrumb justify-content-center mb-0">
                ...
                <li className="breadcrumb-item">
                  <a href="#!">แจ้งเบาะแสการคอร์รัปชัน</a>
                </li>
              ...
              >
                <div className="service-title">
                  ...
                  <p className="fs-5 mb-0">
                    We work to bring smiles, hope, and a brighter future to
                    those in need.
                  </p>
                </div>
              </div>
                      ...
                      <div className="col-md-6">
                        <div className="testimonial-text pb-5 pb-md-0">
                          ...
                          <p className="fs-5">
                            ...
                            help children and adults unlock their potential for
                            a better future.
                          </p>
                    ...
                    <div className="row g-5 align-items-center">
                      ...
                      <div className="col-md-6">
                        <div className="testimonial-text pb-5 pb-md-0">
                          ...
                          <p className="fs-5">
                            Every hand extended in kindness brings us closer to
                            a world free from suffering. Be part of a global
                            movement dedicated to building a future where
                            equality and compassion thrive.
                          </p>
                          <div className="d-flex align-items-center">
                            <div className="btn-lg-square bg-light text-secondary flex-shrink-0">
                              <i className="fa fa-quote-right fa-2x" />
