      ...
      <>
        ...
        >
          <div className="container text-center py-4">
            <h1 className="display-6 animated slideInDown">เกี่ยวกับ</h1>
            <nav aria-label="breadcrumb animated slideInDown">
              <ol className="breadcrumb justify-content-center mb-0">
                ...
                <li className="breadcrumb-item">
                  <a href="#!">รวมพลังต่อต้านคอร์รัปชัน</a>
                </li>
            ...
            <div className="row g-5 align-items-center">
              ...
              <div className="col-lg-6">
                ...
                <p className="mb-4 wow fadeIn" data-wow-delay="0.3s">
                  Every hand extended in kindness brings us closer to a world
                  free from suffering. Be part of a global movement dedicated to
